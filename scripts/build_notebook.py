...
The generated notebook is structured as:
  ...
  cell 0 : markdown  -- the documentation (with a JupyterHub badge)
...
def build_juphub_url(repo: str, branch: str, notebook_path: str) -> str:
    encoded_path = quote(notebook_path, safe="")
    return (
        f"https://hub.nfdi-jupyter.de/v2/gh/{repo}/{branch}"
...
def build_notebook(
    ...
    juphub_url = build_juphub_url(repo, branch, notebook_path)
    badge_md = f"[![JupyterHub](https://nfdi-jupyter.de/images/nfdi_badge.svg)]({juphub_url})"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="GitHub owner/repo (used in the JupyterHub badge).",
    )
